...
class TradeHistoryAdmin(admin.ModelAdmin):
    ...
    search_fields = ("symbol__ticker", "backtest__strategy__name", "correlated_pair__symbol_1__ticker", "correlated_pair__symbol_2__ticker")
...
class SymbolStatisticsAdmin(admin.ModelAdmin):
    ...
    search_fields = ("symbol__ticker", "strategy__name","correlated_pair__symbol_1__ticker", "correlated_pair__symbol_2__ticker")
    list_filter = ("created_at",)
